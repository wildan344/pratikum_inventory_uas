                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="../assets/img/bagas222.jpeg" class="user-image rounded-circle shadow"
                                alt="User Image" />
                            <span class="d-none d-md-inline"><?= htmlspecialchars($username); ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <li class="user-header text-bg-primary">
                                <img src="../assets/img/bagas222.jpeg" class="rounded-circle shadow" alt="User Image" />
                                <p>
                                        ...
                                        <div class="card p-3 shadow-sm">
                                            ...
                                            <form method="POST" action="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="nama_penyimpanan" class="form-control"
                                                        required
                                                        value="<?= $edit_data ? $edit_data['nama_penyimpanan'] : ''; ?>"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="lokasi" class="form-control"
                                                        ...
                                                        placeholder="Contoh: Blok B Lantai 2">
                                                </div>

                                                <button type="submit" name="<?= $edit_data ? 'ubah' : 'tambah' ?>"
                                                    class="btn <?= $edit_data ? 'btn-warning' : 'btn-primary' ?> w-100">
                                                    <?= $edit_data ? 'Simpan Perubahan' : 'Tambah Data' ?>
                                                </button>
                                                <?php if ($edit_data) {
                                                    echo '<a href="penyimpanan.php" class="btn btn-secondary w-100 mt-2">Batal</a>';
                                                } ?>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row['id']; ?></td>
                                                    <td><strong><?= htmlspecialchars($row['nama_penyimpanan']); ?></strong>
                                                    </td>
                                                    <td><?= htmlspecialchars($row['lokasi']); ?></td>
                                                    <td>
                                                        <a href="penyimpanan.php?edit=<?= $row['id']; ?>"
                                                            class="btn btn-sm btn-info text-white">Edit</a>
                                                        <a href="penyimpanan.php?hapus=<?= $row['id']; ?>"
